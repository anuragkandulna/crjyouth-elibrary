                    ...
                    <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                        <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                            <p className="text-xl/8 text-gray-600">
                                Our mission is to make knowledge accessible,
                                engaging, and inspiring for all. We believe that
                                a library is more than a collection of books —
                                it’s a gateway to curiosity, creativity, and
                                lifelong learning.
                            </p>
                            <p className="mt-10 max-w-xl text-base/7 text-gray-700">
                                We strive to provide resources that empower
                                youth, support educators, and foster community
                                connections. By combining traditional wisdom
                                with modern digital tools, we create an
                                inclusive space where everyone can explore
                                ideas, share knowledge, and grow together.
                            </p>
                        </div>
