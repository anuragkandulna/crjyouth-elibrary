...
const stats = [
    { label: "Books in our collection", value: "50,000+" },
    { label: "Active members", value: "2,500+" },
    { label: "Programs annually", value: "200+" },
];
const values = [
    {
        name: "Be world-class",
        ...
        <>
            ...
            <div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8 relative">
                <img
                    ...
                    className="w-full h-auto object-cover outline outline-1 -outline-offset-1 outline-black/5 xl:rounded-3xl"
                />
                <div className="absolute inset-0 flex items-center justify-center bg-black/30 xl:rounded-3xl">
