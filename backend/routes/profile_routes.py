...
from utils.route_utils import token_required, rate_limit, validate_request_data, session_required
from routes.auth_routes import handle_auth_error
from models.user_session import UserSession


user_profile_bp = Blueprint('user_profile_bp', __name__, url_prefix='/api/v1/profile')
...
@user_profile_bp.route('/deactivate', methods=['PUT'])
@session_required
...
@user_profile_bp.route('/membership', methods=['GET'])
@session_required
@rate_limit()
