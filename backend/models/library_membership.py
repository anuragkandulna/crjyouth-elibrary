...
class LibraryMembership(Base):
    ...
    borrowing_limit: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    borrow_duration_days: Mapped[int] = mapped_column(Integer, nullable=False, default=15)
