...
if __name__ == "__main__":
    ...
    try:
        ...
        # ------------------ Seed Users ------------------ #
        predefined_users = [
            ("Admin", "User", "admin@textgpt.live", "1111111111", "J4j>$U13&]Cn", 1, 1),
            ("Mod", "User", "mod@textgpt.live", "2222222222", "8D8*utJ$p9n8", 2, 2),
            ("Member", "User", "member@textgpt.live", "3333333333", "c8z3*nN98y*#", 3, 5)
        ]
